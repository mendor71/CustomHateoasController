...
public class CityHotelService {
    ...
    public void initialize(EntityManager em) {
        ...
        City c1 = new City(1 ,"city1", "defaultCountry", "map1" , "mainState");
        City c2 = new City(2, "city2", "defaultCountry", "map2" , "mainState");
        City c3 = new City(3, "city3", "defaultCountry", "map3" , "mainState");
