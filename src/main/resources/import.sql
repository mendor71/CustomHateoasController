...
-- Tel Aviv
insert into city(id, country, name, state, map) values (5, 'Israel', 'Tel Aviv', 'none', '32.066157, 34.777821')
...
-- Tokyo
insert into city(id, country, name, state, map) values (6, 'Japan', 'Tokyo', 'none', '35.689488, 139.691706')
...
-- Neuchatel
insert into city(id, country, name, state, map) values (8, 'Switzerland', 'Neuchatel', 'none', '46.992979, 6.931933')
...
-- London
insert into city(id, country, name, state, map) values (10, 'UK', 'London', 'none', '51.500152, -0.126236')
...
insert into hotel(id, city, name, address, zip) values (21, 21, 'Hotel Rouge', '1315 16th Street NW', '20036')
